...
public class HomeController {
	...
	/*
	 * @RequestMapping(method =RequestMethod.POST,path = "/hello") public String
	 * sayHello(HttpServletRequest request,Model theModel) {
	 * //request.setAttribute("ATTR1", request.getParameter("t1"));
	 * 
	 * theModel.addAttribute("ATTR1",request.getParameter("t1") ); return "hello"; }
	 */
